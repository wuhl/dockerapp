FROM ubuntu:utopic
MAINTAINER Wolfgang Uhl <wolfgang.uhl@googlemail.com>

# Just use bash.
RUN rm /bin/sh && ln -s /bin/bash /bin/sh

# Debian aomplains about the terminal environment on Docker. Use this.
...
# Finish installint remaining dependencies
